        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                @if(auth()->user()->isHRAdmin())
                    <a href="{{ route('reports.hr') }}" class="group bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow duration-200 border border-gray-200 hover:border-primary-300">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                            ...
                            <div class="ml-4">
                                <h3 class="text-sm font-medium text-gray-900 group-hover:text-primary-700">HR Reports</h3>
                                <p class="text-sm text-gray-500">View comprehensive analytics and insights</p>
                            </div>
                        </div>
                    </a>

                    <a href="{{ route('settings') }}" class="group bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow duration-200 border border-gray-200 hover:border-primary-300">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                            ...
                            <div class="ml-4">
                                <h3 class="text-sm font-medium text-gray-900 group-hover:text-primary-700">System Settings</h3>
                                <p class="text-sm text-gray-500">Configure system parameters</p>
                            </div>
                        </div>
                    </a>

                    <a href="{{ route('audit.logs') }}" class="group bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow duration-200 border border-gray-200 hover:border-primary-300">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                            ...
                            <div class="ml-4">
                                <h3 class="text-sm font-medium text-gray-900 group-hover:text-primary-700">Audit Logs</h3>
                                <p class="text-sm text-gray-500">Monitor system activities</p>
                            </div>
                        </div>
                    </a>
                @else
                    <a href="{{ route('reports.payroll') }}" class="group bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow duration-200 border border-gray-200 hover:border-primary-300">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                            ...
                            <div class="ml-4">
                                <h3 class="text-sm font-medium text-gray-900 group-hover:text-primary-700">Payroll Reports</h3>
                                <p class="text-sm text-gray-500">View payment analytics and summaries</p>
                            </div>
                        </div>
                    </a>
                @endif
